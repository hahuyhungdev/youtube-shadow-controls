# YouTube Shadow Controls

A keyboard-first Chrome and Microsoft Edge extension for language shadowing practice on YouTube.
...
Shortcuts are disabled while typing in inputs, text areas, select menus, or editable text.
...
4. Select the `youtube-shortcut-control` folder.
5. Reload any open YouTube tabs after installing or updating.

After changing extension files, click the reload button on the extension card and refresh YouTube.
